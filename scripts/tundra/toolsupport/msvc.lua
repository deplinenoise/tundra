...
-- tundra/toolsupport/msvc.lua - support for configuring the MSVC toolset
...
function setup(env, target_arch, host_arch)
	if not host_arch then
	...
	env:set_external_env_var('FrameworkVersion', frameworkVersion)
	...
	path[#path + 1] = frameworkDir .. "\\" .. frameworkVersion
