...
-- msvc-vs2010.lua - Settings to use Microsoft Visual Studio 2010 from the
-- registry.
...
local vs10_key = "SOFTWARE\\Microsoft\\VisualStudio\\10.0"
local idePath = assert(native.reg_query("HKLM", vs10_key, "InstallDir"))
