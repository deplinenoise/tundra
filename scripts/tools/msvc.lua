...
env:set_many {
	...
	["CPPDEFS"] = "_WIN32",
	["CCOPTS"] = "/W4",
	["CCCOM"] = "$(CC) /c $(CPPDEFS:p/D) $(CPPPATH:b:p/I) /nologo $(CCOPTS) $(CCOPTS_$(CURRENT_VARIANT:u)) /Fo$(@:b) $(<:b)",
	["CXXCOM"] = "$(CC) /c $(CPPDEFS:p/D) $(CPPPATH:b:p/I) /nologo $(CCOPTS) $(CCOPTS_$(CURRENT_VARIANT:u)) /Fo$(@:b) $(<:b)",
	["LIBS"] = "",
	["PROGOPTS"] = "",
